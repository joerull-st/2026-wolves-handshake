...
<Grid additionalClasses="gap-y-8 md:gap-y-10">
    ...
    <GridRow variant={"fullBleed"}>
      <div class="relative flex items-center justify-center h-screen mb-4 overflow-hidden bg-[white] xl:max-h-[1000px] lg:max-h-[900px] md:max-h-[800px] xs:max-h-[650px]">
        <div class="absolute left-8 bottom-4 md:min-w-[800px] xs:min-w-[80%] xs:left-2 xs:top-2 z-30 xl:p-6 lg:p-4 md:p-4 xs:p-2 text-2xl !text-[white] text-left font-editorial-news-heading-01 max-w-[700px] mt-auto drop-shadow-md">

            <h1 class="xs:hidden md:block absolute bottom-0 xl:text-[3.5rem] lg:text-[3.5rem] md:text-[2.25rem] xs:text-[2rem] bg-[#0c2340] p-4">Timberwolves guard Mike Conley<br>is a man of 1,000 handshakes.<br>Well, close.</h1>

            <h1 class="xs:block md:hidden absolute bottom-0 xs:text-[2rem] bg-[#0c2340] p-4">Timberwolves guard<br>Mike Conley is a man<br>of 1,000 handshakes.<br>Well, close.</h1>
        </div>
